...
class A090502ProductOrderDetailEditTeam extends StatefulWidget {
  final String? customerID;
  final List<String>? imageProduct;
  final Map<String, dynamic>? orderOLD;
  ...
  const A090502ProductOrderDetailEditTeam({
    super.key,
    this.orderDataMap,
    this.imageProduct,
    this.customerID,
  ...
  @override
  _A090502ProductOrderDetailEditTeamState createState() =>
      _A090502ProductOrderDetailEditTeamState();
}

class _A090502ProductOrderDetailEditTeamState
    extends State<A090502ProductOrderDetailEditTeam> {
  ...
  Future<void> loadData(String? edit, Map<String, dynamic>? order) async {
    ...
    try {
      ...
      for (int i = 0; i < orderList['ProductList'].length; i++) {
        if (orderList['ProductList'][i]['productHistory'] == null) {
          orderList['ProductList'][i]['productHistory'] = false;
        }
      }

      await checkPromotions(false);
...
// I/flutter (11081): {Envelope: {soap: http://www.w3.org/2003/05/soap-envelope, xsi: http://www.w3.org/2001/XMLSchema-instance, xsd: http://www.w3.org/2001/XMLSchema, Body: {BILL_DISCOUNT_INFOResponse: {xmlns: MFOODMOBILEAPI, BILL_DISCOUNT_INFOResult: {RESULT: true, BILLING_DISCOUNT_PERCENT: 2%, BILLING_DISCOUNT_BAHT: 0}}}}}
  ...
  Future<void> checkPromotions(bool checkButton) async {
...
// </soap12:Envelope>
      ...
      await callableDiscount.call(paramsDiscount).then((value) async {
        print('ข้อมูลที่ส่งกลับจาก cloud function inde $i ${value.data}');
        if (value.data['status'] == 'success') {}
        ...
        if (data['Envelope']['Body']['SALES_ITEM_PROMOTIONResponse']
                ['SALES_ITEM_PROMOTIONResult'] ==
            'true') {
          if (orderList['ProductList'][i]['productHistory'] && !checkButton) {
            print('เข้าสินค้าเก่า1');
            orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
          } else {
            print('ไม่เข้าสินค้าเก่า1');
            orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
          ...
          if (data['Envelope']['Body']['SALES_ITEM_PROMOTIONResponse']
            ...
            for (int j = 0; j < filteredList.length; j++) {
              ...
              if (sellPriceResponse['PRODUCT_TYPE'] == 'ITEM DISCOUNT') {
                ...
                if (orderList['ProductList'][i]['productHistory'] &&
                    !checkButton) {
                  print('เข้าสินค้าเก่า2');
                  orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
                } else {
                  print('ไม่เข้าสินค้าเก่า2');
                ...
                if (orderList['ProductList'][i]['productHistory'] &&
                    !checkButton) {
                  print('เข้าสินค้าเก่า3');
                  orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
                } else {
                  print('ไม่เข้าสินค้าเก่า3');
                  orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
            ...
            if (sellPriceResponse['PRODUCT_TYPE'] == 'ITEM DISCOUNT') {
              ...
              if (orderList['ProductList'][i]['productHistory'] &&
                  !checkButton) {
                print('เข้าสินค้าเก่า4');
                orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
              } else {
                print('ไม่เข้าสินค้าเก่า4');
              ...
              if (orderList['ProductList'][i]['productHistory'] &&
                  !checkButton) {
                print('เข้าสินค้าเก่า5');
                orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
              } else {
                print('ไม่เข้าสินค้าเก่า5');
                orderList['ProductList'][i]['ส่วนลดรายการ'] = '0.0';
                                                                                  ...
                                                                                  child: StatefulBuilder(builder: (context, setState) {
                                                                                    return Row(
                                                                                      ...
                                                                                      children: [
                                                                                        GestureDetector(
                                                                                          onTap: () async {
                                                                                            Map<String, dynamic>? foundmapRatioBase = productCovertRatio.firstWhere(
                                                                                              (element) => element!['PRODUCT_ID'] == orderList['ProductList'][i]['ProductID'] && element['UNIT'] == orderList['ProductList'][i]['ยูนิต'],
                                                                                              orElse: () => {},
                                                                                            );

                                                                                            //-----------------------------

                                                                                            List<dynamic>? dynamicList = widget.orderOLD!['ProductList'];

                                                                                            for (var element in dynamicList!) {
                                                                                              print(element);
                                                                                            }

                                                                                            List<Map<String, dynamic>>? foundmapOrderOldList = dynamicList!.cast<Map<String, dynamic>>();

                                                                                            Map<String, dynamic> foundmapOrderOld = foundmapOrderOldList.firstWhere(
                                                                                              (element) => element!['ProductID'] == orderList['ProductList'][i]['ProductID'] && element['ยูนิต'] == orderList['ProductList'][i]['ยูนิต'],
                                                                                              orElse: () => {},
                                                                                            );
                                                                                            print('ORDER OLD');
                                                                                            print(foundmapOrderOld['จำนวน']);

                                                                                            //-----------------------------

                                                                                            double totalBalanaceBefore = 0.0;

                                                                                            if (foundmapOrderOld.isEmpty) {
                                                                                            } else {
                                                                                              totalBalanaceBefore = double.parse(foundmapOrderOld!['จำนวน'].toString()) * double.parse(foundmapRatioBase!['CONVERT_RATIO'].toString());
                                                                                            }
                                                                                            //-----------------------------

                                                                                            double totalBalanace = 0.0;
                                                                                            int totalUnitSum = productCount[i] - 1;

                                                                                            double totalUnit = double.parse(totalUnitSum.toString()) * double.parse(foundmapRatioBase!['CONVERT_RATIO'].toString());

                                                                                            NumberFormat numberFormatConvertRatio = NumberFormat("#.000000");
                                                                                            String formattedNumberConvertRatio = numberFormatConvertRatio.format(totalUnit);
                                                                                            // print(formattedNumber);
                                                                                            totalUnit = double.parse(formattedNumberConvertRatio);

                                                                                            print(foundmapRatioBase!['CONVERT_RATIO']);
                                                                                            print(foundmapRatioBase!['CONVERT_RATIO']);
                                                                                            print(foundmapRatioBase!['CONVERT_RATIO']);
                                                                                            ...
                                                                                            Map<String, dynamic>? foundMap = resultList.firstWhere(
                                                                                              (element) => element['PRODUCT_ID'] == orderList['ProductList'][i]['ProductID'],
                                                                                              orElse: () => {},
                                                                                            );
                                                                                            //=============== โหลด balance อีกครั้ง =========================

                                                                                            QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection(AppSettings.customerType == CustomerType.Test ? 'ProductTest' : 'Product').where('PRODUCT_ID', isEqualTo: foundMap['PRODUCT_ID']).get();
                                                                                            if (querySnapshot.docs.isNotEmpty) {
                                                                                              ...
                                                                                              for (var doc in querySnapshot.docs) {
                                                                                                ...
                                                                                                totalBalanace = double.parse(data['Balance'].toString());
                                                                                                // print(foundMap['Balance']);
                                                                                              }
                                                                                            } else {
                                                                                            ...
                                                                                            print(totalUnit);
                                                                                            print(totalBalanace);
                                                                                            totalBalanace = totalBalanace + totalBalanaceBefore;

                                                                                            print(totalBalanaceBefore);
                                                                                            print(totalBalanace);

                                                                                            if (totalUnit > totalBalanace && orderList!['SectionID2'] != 'บุ๊กกิ้งออเดอร์') {
                                                                                              Fluttertoast.showToast(
                                                                                                msg: 'สินค้าไม่พอสำหรับการสั่งค่ะ',
                                                                                              ...
                                                                                              await checkPromotions(true).whenComplete(() => CustomProgressDialog.hide(context));
                                                                                            }
                                                                                          },
                                                                                          child: Container(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      ...
                                                                                                      TextFormField(
                                                                                                        ...
                                                                                                        onEditingComplete: () async {
                                                                                                          ...
                                                                                                          double totalBalanace = 0.0;
                                                                                                          double totalUnit = double.parse(productCount[i].toString()) * double.parse(foundmapRatioBase!['CONVERT_RATIO'].toString());
                            ...
                            onPressed: () async {
                              ...
                              QuerySnapshot orderSubCollections =
                                  await orderColection
                                      .where('OrdersDateID',
                                          isEqualTo: orderList['OrdersDateID'])
                                      .get();
                              ...
                              if (orderSubCollections.docs.isNotEmpty) {
                                ...
                                } else if (orderSubCollections
                                            .docs.first['SectionID2'] ==
                                        '20240309000002'
                                    //     &&
                                    // orderSubCollections
                                    //         .docs.first['SALE_ORDER_ID_REF'] !=
                                    //     null
                                    ) {
                                  checkLastStatus = true;
                                }
                              ...
                              if (!checkLastStatus) {
                                if (mounted) {
                                  await QuickAlert.show(
                                      ...
                                      title: 'การแก้ไขออเดอร์ไม่สามารถทำได้',
                                      text:
                              ...
                              try {
                                ...
                                if (orderList['ProductList'].length == 0) {
                                  ...
                                  for (int i = 0;
                                      i < orderList['ProductList'].length;
                                      i++) {
                                    bool isStringFound = listHistoryString.any(
                                        (map) =>
                                            map ==
                                            orderList['ProductList'][i]
                                                ['ProductID']);
                                  ...
                                  DateFormat dateFormatCheckStatus =
                                      DateFormat("dd-MM-yyyy");
                                  DateTime parsedDateEnd = dateFormatCheckStatus
                                      .parse(dateStringEnd);

                                  // ตรวจสอบว่า parsedDate เป็นวันหลังจากวันปัจจุบันหรือไม่
                                  checkDateEnd = parsedDateEnd.isAfter(nowEnd);

                                  print(orderList);

                                  orderList.forEach((key, value) {
                                    if (key == 'ProductList') {
                                      print('${key}New : ${value.length}');
                                    } else {
                                      print('$key : $value');
                                    }
                                  });

                                  widget.orderOLD!.forEach((key, value) {
                                    if (key == 'ProductList') {
                                      print('${key}OLD : ${value.length}');
                                    } else {
                                      print('$key : $value');
                                    }
                                  });
                                  ...
                                  if (sectionID2 == '20240309000002') {
                                    print('sectionID2 == 20240309000002');
                                  } else {
                                    await FirebaseFirestore.instance
                                        .collection(AppSettings.customerType ==
                                                CustomerType.Test
                                            ...
                                            : 'Ordersก่อนแก้ไข')
                                        .doc(
                                            '${widget.orderOLD!['CustomerDocId']}_${widget.orderOLD!['OrdersDateID']}')
                                        .set({
                                      'OrdersDateID':
                                          widget.orderOLD!['OrdersDateID'],
                                      'OrdersUpdateTime': DateTime.now(),
                                      'สถานที่จัดส่ง':
                                          widget.orderOLD!['สถานที่จัดส่ง'],
                                      'วันเวลาจัดส่ง':
                                          DateFormat("dd-MM-yyyy").parse(
                                        widget.orderOLD!['วันเวลาจัดส่ง'],
                                      ),
                                      // widget.orderOLD!['วันเวลาจัดส่ง'],
                                      'สายส่ง': widget.orderOLD!['สายส่ง'],
                                      'สายส่งโค้ด':
                                          widget.orderOLD!['สายส่งโค้ด'],
                                      'สายส่งไอดี':
                                          widget.orderOLD!['สายส่งไอดี'],
                                      'ProductList': orderList['ProductList'],

                                      'ยอดรวม': widget.orderOLD!['ยอดรวม'],
                                      'ส่วนลด': widget.orderOLD!['ส่วนลด'],
                                      'มูลค่าสินค้าที่ยกเว้นภาษีมูลค่าเพิ่ม':
                                          widget.orderOLD![
                                              'มูลค่าสินค้าที่ยกเว้นภาษีมูลค่าเพิ่ม'],
                                      'มูลค่าสินค้าที่รวมภาษีมูลค่าเพิ่ม': widget
                                              .orderOLD![
                                          'มูลค่าสินค้าที่รวมภาษีมูลค่าเพิ่ม'],
                                      'มูลค่าสินค้าที่เสียภาษีมูลค่าเพิ่ม': widget
                                              .orderOLD![
                                          'มูลค่าสินค้าที่เสียภาษีมูลค่าเพิ่ม'],
                                      'ภาษีมูลค่าเพิ่ม':
                                          widget.orderOLD!['ภาษีมูลค่าเพิ่ม'],
                                      'มูลค่าสินค้ารวม':
                                          widget.orderOLD!['มูลค่าสินค้ารวม'],
                                      'วันเวลาจัดส่ง_string':
                                          DateFormat("dd-MM-yyyy")
                                              .parse(
                                                widget
                                                    .orderOLD!['วันเวลาจัดส่ง'],
                                              )
                                              .toString(),

                                      // widget.orderOLD!['วันเวลาจัดส่ง'],
                                      'วันเวลาจัดส่ง_day':
                                          widget.orderOLD!['วันเวลาจัดส่ง_day'],
                                      'ListCustomerAddressID': widget
                                          .orderOLD!['ListCustomerAddressID'],
                                      'ตารางราคา':
                                          widget.orderOLD!['ตารางราคา'],
                                      'ค้างชำระ': 0,
                                      'สถานะเอกสาร':
                                          widget.orderOLD!['สถานะเอกสาร'],
                                      'สถานะอนุมัติขาย':
                                          widget.orderOLD!['สถานะอนุมัติขาย'],
                                      'รอตรวจการอนุมัติ':
                                          widget.orderOLD!['รอตรวจการอนุมัติ'],
                                      'ProductListDocument': listProductReal,
                                      'สถานะเช็คสต็อก':
                                          widget.orderOLD!['สถานะเช็คสต็อก'],
                                      'PO': widget.orderOLD!['PO'],
                                      'หมายเหตุ': widget.orderOLD!['หมายเหตุ'],
                                      'SALE_ORDER_ID':
                                          widget.orderOLD!['SALE_ORDER_ID'],
                                      'SALE_ORDER_ID_REF':
                                          widget.orderOLD!['SALE_ORDER_ID_REF'],
                                      'SectionID2': sectionID2,
                                      'UserDocId':
                                          widget.orderOLD!['UserDocId'],
                                      'Timestampวันที่แก้ไข': widget
                                          .orderOLD!['Timestampวันที่แก้ไข'],
                                      'CustomerDocId':
                                          widget.orderOLD!['CustomerDocId'],
                                      'CustomerDoc':
                                          widget.orderOLD!['CustomerDoc'],
                                      'ProductListOld':
                                          widget.orderOLD!['ProductList'],
                                      'มีการแก้ไขผ่านแอพวันที่': DateTime.now(),
                                      'มีการแก้ไขผ่านแอพโดย':
                                          userData!['EmployeeID'],
                                      'ProjectID2':
                                          widget.orderOLD!['ProjectID2'],
                                    });
                                  }
                                  ...
                                  //         ? 'OrdersTestก่อนแก้ไข'
                                  //         : 'Ordersก่อนแก้ไข')
                                  //     .doc(orderList['OrdersDateID'])
                                  //     .set({
                                  //   'OrdersDateID': orderList['OrdersDateID'],
                                  //   'OrdersUpdateTime': DateTime.now(),
                                  //   'สถานที่จัดส่ง': orderList['สถานที่จัดส่ง'],
                                  //   'วันเวลาจัดส่ง': orderList['วันเวลาจัดส่ง'],
                                  //   'สายส่ง': orderList['สายส่ง'],
                                  //   'สายส่งโค้ด': orderList['สายส่งโค้ด'],
                                  //   'สายส่งไอดี': orderList['สายส่งไอดี'],
                                  //   'ProductList': orderList['ProductList'],
                                  ...
                                  //   'ตารางราคา': orderList['ตารางราคา'],
                                  //   'ค้างชำระ': 0,
                                  //   'สถานะเอกสาร': orderList['สถานะเอกสาร'],
                                  //   'สถานะอนุมัติขาย': orderList['สถานะอนุมัติขาย'],
                                  //   'รอตรวจการอนุมัติ': orderList['รอตรวจการอนุมัติ'],
                                  //   'ProductListDocument': listProductReal,
                                  //   'สถานะเช็คสต็อก':
                                  //       orderList['สถานะเช็คสต็อก'],
                                  //   'PO':  orderList['PO'],
                                  //   'หมายเหตุ': orderList['หมายเหตุ'],
                                  // });
                                  ...
                                  await FirebaseFirestore.instance
                                    ...
                                    'ตารางราคา': orderList['ตารางราคา'],
                                    'ค้างชำระ': 0,
                                    'สถานะค้างชำระ': orderList['สถานะค้างชำระ'],
                                    'สถานะเอกสาร': orderList['สถานะเอกสาร'],
                                    'สถานะอนุมัติขาย':
                                        orderList['สถานะอนุมัติขาย'],
                                    'รอตรวจการอนุมัติ':
                                        orderList['รอตรวจการอนุมัติ'],
                                    'ProductListDocument': listProductReal,
                                    'สถานะเช็คสต็อก':
                                        orderList['สถานะเช็คสต็อก'],
                                    'PO': orderList['PO'],
                                    ...
                                    'SectionID2': sectionID2,
                                    'UserDocId': orderList!['UserDocId'],
                                    'Timestampวันที่แก้ไข':
                                        orderList!['Timestampวันที่แก้ไข'],
                                    'CustomerDocId': orderList['CustomerDocId'],
                                    'CustomerDoc': orderList!['CustomerDoc'],
                                    'ProductListOld':
                                        orderList['ProductListOld'],
                                    'มีการแก้ไขผ่านแอพวันที่': DateTime.now(),
                                    'มีการแก้ไขผ่านแอพโดย':
                                        userData!['EmployeeID'],
                                    'ProjectID2': orderList!['ProjectID2'],
                                    'เปิดออเดอร์แทน': true,
                                    'idผู้เปิดออเดอร์แทน':
                                        userData!['EmployeeID'],
                                    // 'OrdersDateID': orderID,
                                    ...
                                    //===========================================================================================
                                    String? data =
                                        await readDataFromSharedPreferences(
                                            'message_key');
                                    ...
                                    HttpsCallable callable = FirebaseFunctions
                                        .instance
                                        .httpsCallable('apiConfirmEditOrder');
                                    var params = <String, dynamic>
                                        // {
                                      ...
                                      "CustomerDocId": widget.customerID,
                                      "OrdersDateID": orderList['OrdersDateID'],
                                      "UserDocId": widget.idEmployee,
                                      // "CustomerDocId": widget.customerID,
                                      // "OrdersDateID": orderList['OrdersDateID'],
                                      // "UserDocId": orderList!['UserDocId'],
                                      "สถานะค้างชำระ":
                                          orderList!['สถานะค้างชำระ'],
                                      "รอตรวจการอนุมัติ":
                                          orderList!['รอตรวจการอนุมัติ'],
                                      "สถานะอนุมัติขาย":
                                          orderList!['สถานะอนุมัติขาย'],
                                    ...
                                    await callable
                                      ...
                                      if (value.data['status'] == 'success') {
                                        ...
                                        await FirebaseFirestore.instance
                                            ...
                                            .doc(
                                                '${widget.customerID}_${orderList['OrdersDateID']}')
                                            .set({
                                          'OrdersDateID':
                                          ...
                                          'SectionID2': sectionID2,
                                          'UserDocId': orderList!['UserDocId'],
                                          'Timestampวันที่แก้ไข': orderList![
                                              'Timestampวันที่แก้ไข'],
                                          'CustomerDocId':
                                              orderList['CustomerDocId'],
                                          'CustomerDoc':
                                              orderList!['CustomerDoc'],
                                          'ProductListOld':
                                              orderList['ProductListOld'],
                                          'มีการแก้ไขผ่านแอพวันที่':
                                              DateTime.now(),
                                          'มีการแก้ไขผ่านแอพโดย':
                                              userData!['EmployeeID'],
                                          'ProjectID2':
                                              orderList!['ProjectID2'],
                                          // 'OrdersDateID': orderID,
                                          // 'OrdersUpdateTime': DateTime.now(),
                                          // 'สถานที่จัดส่ง':
                                          //     orderList['สถานที่จัดส่ง'],
