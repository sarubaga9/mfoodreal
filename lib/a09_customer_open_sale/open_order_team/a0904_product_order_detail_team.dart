...
class A0904ProductOrderDetailTeam extends StatefulWidget {
  ...
  const A0904ProductOrderDetailTeam({
    super.key,
    this.orderDataMap,
    this.imageProduct,
    this.customerID,
  ...
  @override
  _A0904ProductOrderDetailTeamState createState() =>
      _A0904ProductOrderDetailTeamState();
}

class _A0904ProductOrderDetailTeamState
    extends State<A0904ProductOrderDetailTeam> {
                                                                          ...
                                                                          onChanged: (i == 0 || i == 2) && productPreAll
                                                                              ...
                                                                              : (value) {
                                                                                  ...
                                                                                  if (i == 0) {
                                                                                    ...
                                                                                    for (int j = 0; j < orderList['ProductList'].length; j++) {
                                                                                      print('ตัวเลือก 3 Check 2.1');

                                                                                      print(orderList['ProductList'][j]['จำนวน']);
                                                                                      // print(orderList['ProductList'][j]['รายการนี้เกินสต๊อก']);
                                                                                      // print(stockAll[j]);

                                                                                      // print(stockOrderAll[j]);

                                                                                      // stockOrderAll[j] = orderList['ProductList'][j]['จำนวน'].toStringAsFixed(0);
