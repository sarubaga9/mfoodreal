...
class A0714RejectWidget extends StatefulWidget {
  const A0714RejectWidget({Key? key}) : super(key: key);

  @override
  _A0714RejectWidgetState createState() => _A0714RejectWidgetState();
}

class _A0714RejectWidgetState extends State<A0714RejectWidget> {
  ...
  Widget build(BuildContext context) {
    print('==============================');
    print('This is A0713 accept ผ่านอนุมัติ  Screen');
    print('==============================');
                                ...
                                children: [
                                  ...
                                  StreamBuilder(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      sortedKeys.sort((a, b) => filteredData[b]
                                              ['CustomerDateUpdate']
                                          .compareTo(filteredData[a]
                                              ['CustomerDateUpdate']));

                                      Map<String, dynamic> sortedFilteredData =
                                          Map.fromEntries(
                                        sortedKeys.map((key) =>
                                            MapEntry(key, filteredData[key])),
                                      );
