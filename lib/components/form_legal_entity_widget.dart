import '/components/signature_copy_widget.dart';
...
import 'form_legal_entity_model.dart';
export 'form_legal_entity_model.dart';

class FormLegalEntityWidget extends StatefulWidget {
  const FormLegalEntityWidget({Key? key}) : super(key: key);

  @override
  _FormLegalEntityWidgetState createState() => _FormLegalEntityWidgetState();
}

class _FormLegalEntityWidgetState extends State<FormLegalEntityWidget> {
  late FormLegalEntityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormLegalEntityModel());
