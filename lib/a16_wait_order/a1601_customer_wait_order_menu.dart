...
class A1601CustomerWaitOrderMenu extends StatefulWidget {
  ...
  final String? status;
  const A1601CustomerWaitOrderMenu({
    super.key,
    this.status,
  ...
  @override
  _A1601CustomerWaitOrderMenuState createState() =>
      _A1601CustomerWaitOrderMenuState();
}

class _A1601CustomerWaitOrderMenuState
    extends State<A1601CustomerWaitOrderMenu> {
