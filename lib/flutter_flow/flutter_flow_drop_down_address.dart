...
import 'package:m_food/flutter_flow/form_field_dropdown_controller.dart';

import 'form_field_controller.dart';
import 'package:flutter/material.dart';

class FlutterFlowDropDownAddress<T> extends StatefulWidget {
  ...
  final FormFieldDropdownController<T> controller;
  ...
  @override
  State<FlutterFlowDropDownAddress<T>> createState() => _FlutterFlowDropDownAddressState<T>();
}

class _FlutterFlowDropDownAddressState<T> extends State<FlutterFlowDropDownAddress<T>> {
