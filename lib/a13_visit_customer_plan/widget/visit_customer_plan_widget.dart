...
class VisitCustomerPlanWidget extends StatefulWidget {
  const VisitCustomerPlanWidget({super.key});

  @override
  _VisitCustomerPlanWidgetState createState() =>
      _VisitCustomerPlanWidgetState();
}

class _VisitCustomerPlanWidgetState extends State<VisitCustomerPlanWidget> {
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        'แผนการเข้าเยี่ยมประจำวันที่ ${uniqueDates[j]}',
