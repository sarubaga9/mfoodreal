import '/components/appbar_search_copy_widget.dart';
...
import 'a0101_home_copy_model.dart';
export 'a0101_home_copy_model.dart';

class A0101HomeCopyWidget extends StatefulWidget {
  const A0101HomeCopyWidget({Key? key}) : super(key: key);

  @override
  _A0101HomeCopyWidgetState createState() => _A0101HomeCopyWidgetState();
}

class _A0101HomeCopyWidgetState extends State<A0101HomeCopyWidget> {
  late A0101HomeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A0101HomeCopyModel());
  }
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: wrapWithModel(
                          model: _model.appbarSearchCopyModel,
                          updateCallback: () => setState(() {}),
                          child: AppbarSearchCopyWidget(),
                        ),
                      ),
                    ),
                  ],
