...
class A1302VisitDetail extends StatefulWidget {
  final MapEntry<String, dynamic>? entry;
  const A1302VisitDetail({this.entry, super.key});

  @override
  _A1302VisitDetailState createState() => _A1302VisitDetailState();
}

class _A1302VisitDetailState extends State<A1302VisitDetail> {
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child:  DetailVisitCustomerPlanWidget(entry: widget.entry,),
                              ),
                            ),
                          ],
                        ),
