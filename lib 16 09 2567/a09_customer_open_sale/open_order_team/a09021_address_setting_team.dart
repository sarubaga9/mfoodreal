...
import 'package:m_food/a09_customer_open_sale/open_order_team/a0903_product_screen_team.dart';
...
class A09021AddressSettingTeam extends StatefulWidget {
  final String? edit;
  ...
  const A09021AddressSettingTeam({
    super.key,
    this.edit,
    this.orderDataMap,
    this.customerID,
  ...
  @override
  _A09021AddressSettingTeamState createState() =>
      _A09021AddressSettingTeamState();
}

class _A09021AddressSettingTeamState extends State<A09021AddressSettingTeam> {
  ...
  void fetchData() async {
    ...
    //==============================================================
      ...
      //     waySendList.add('${element['VHC_CODE']} ${element['VHC_DESC']} ${element['ประเภทส่ง']}');
      //   }
      // }
                ...
                for (var element2
                  ...
                  if (element2 == postalCode) {
                    ...
                    if (element['วันที่จัดส่ง']['ส่งทุกวัน']) {
                      waySendList.add(
                          '${element['VHC_CODE']} ${element['VHC_DESC']} ${element['ประเภทส่ง']}');
                      // print('ส่งทุกวัน');
                    } else {
                      // print('ส่งไม่ทุกวัน');
                                    ...
                                    if (waySendDropdownController.text ==
                                      ...
                                      foundMap = waySendListData?.firstWhere(
                                        (Map<String, dynamic>? map) =>
                                            '${map?['VHC_CODE']} ${map?['VHC_DESC']} ${map?['ประเภทส่ง']}'
                                            // map?['VHC_DESC']
                                            ==
                                            waySendDropdownController.text,
                                      );
