...
class CheckInWidget extends StatefulWidget {
  ...
  const CheckInWidget({this.entry, super.key});
...
class _CheckInWidgetState extends State<CheckInWidget> {
  ...
  Future<void> checkDistanceGPS(double customerLataitude,
      double customerLongtitude, BuildContext context) async {
    print('---------------------------------------------------------------');
    ...
    // print(customerLataitude);
    // print(customerLongtitude);
    ...
    try {
      ...
      if (permission == LocationPermission.denied) {
        ...
        print(userLat);
        print(userLong);
        double customerLat = customerLataitude;
        double customerLong = customerLongtitude;
        ...
        if (customerLong == 0 ||
          ...
          Fluttertoast.showToast(
            msg: "พบปัญหาผิดพลาดจากระบบวัดระยะทางค่ะ",
          ...
          distanceInMeters = Geolocator.distanceBetween(
              userLat, userLong, customerLat, customerLong);

          print(distanceInMeters);
          double fixInArea = 200.00;

          if (distanceInMeters <= fixInArea) {
            //คุณอยู่ในพื้นที่ที่กำหนด  และ เขียนโค้ดที่ต้องการได้เลย
            ...
            Fluttertoast.showToast(
              msg: "คุณอยู่ห่างจากสถานที่ลูกค้ามากกว่า 200 เมตรค่ะ",
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.TOP,
              timeInSecForIosWeb: 4,
              backgroundColor: Colors.red.shade900,
            ...
            //คุณไม่อยู่ในพื้นที่ที่กำหนด และ เขียนโค้ดที่แจ้งเตือนได้เลย
          }
        }
        userLat = 0;
        userLong = 0;
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          for (int i = 5; i > imageUint8List.length; i--)
                            Padding(
