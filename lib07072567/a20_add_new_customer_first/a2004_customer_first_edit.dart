...
class A2004CustomerFirstEdit extends StatefulWidget {
  final Map<String, dynamic>? entryMap;
  const A2004CustomerFirstEdit({@required this.entryMap, Key? key})
      : super(key: key);

  @override
  _A2004CustomerFirstEditState createState() => _A2004CustomerFirstEditState();
}

class _A2004CustomerFirstEditState extends State<A2004CustomerFirstEdit> {
