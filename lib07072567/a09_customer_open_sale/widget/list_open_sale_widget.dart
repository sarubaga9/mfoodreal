...
class ListOpenSaleWidget extends StatefulWidget {
  const ListOpenSaleWidget({super.key});

  @override
  _ListOpenSaleWidgetState createState() => _ListOpenSaleWidgetState();
}

class _ListOpenSaleWidgetState extends State<ListOpenSaleWidget> {
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    customerDataList[i]['ClientIdจากMfoodAPI'],
