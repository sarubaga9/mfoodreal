...
import 'save_accout_model.dart';
export 'save_accout_model.dart';

class SaveAccoutWidget extends StatefulWidget {
  const SaveAccoutWidget({Key? key}) : super(key: key);

  @override
  _SaveAccoutWidgetState createState() => _SaveAccoutWidgetState();
}

class _SaveAccoutWidgetState extends State<SaveAccoutWidget> {
  late SaveAccoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaveAccoutModel());
