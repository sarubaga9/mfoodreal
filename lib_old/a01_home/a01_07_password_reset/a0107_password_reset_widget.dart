...
class A0107PasswordResetWidget extends StatefulWidget {
  const A0107PasswordResetWidget({Key? key}) : super(key: key);
...
class _A0107PasswordResetWidgetState extends State<A0107PasswordResetWidget> {
  late A0107PasswordResetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A0107PasswordResetModel());
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      hintText: 'พิมพ์พาสเวิร์ดใหม่ที่นี่',
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      hintText: 'พิมพ์พาสเวิร์ดใหม่อีกครั้ง',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      enabledBorder: OutlineInputBorder(
                                        borderSide: BorderSide(
                          ...
                          children: [
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('A01_04_DataTransferCopy');
                                },
