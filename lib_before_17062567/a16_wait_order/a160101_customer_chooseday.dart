...
class A160101CustomerChooseDay extends StatefulWidget {
  ...
  @override
  _A160101CustomerChooseDayState createState() =>
      _A160101CustomerChooseDayState();
}

class _A160101CustomerChooseDayState extends State<A160101CustomerChooseDay> {
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    //         .fromSTEB(3.0, 0.0, 0.0, 0.0),
                                    //     child: Text(
                                    //       'สมชาย วงศ์พัฒนากุล กำหนดดูแล วันที่ ${DateFormat("dd-MM-yyyy").format(DateTime.parse(mapDataOrdersData![0]!['OrdersDateID']))}',
                                    //       style: FlutterFlowTheme.of(context)
                                    //           .bodyLarge
                                    //           .override(
                                    //               fontSize: 20,
