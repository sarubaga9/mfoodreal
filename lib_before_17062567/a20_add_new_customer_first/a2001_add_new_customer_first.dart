...
import 'package:m_food/a20_add_new_customer_first/a200101_pdpa_account_widget.dart';
import 'package:m_food/a20_add_new_customer_first/a2003_customer_first_list.dart';
...
class A2001AddNewCustomerFirst extends StatefulWidget {
  const A2001AddNewCustomerFirst({Key? key}) : super(key: key);

  @override
  _A2001AddNewCustomerFirstState createState() =>
      _A2001AddNewCustomerFirstState();
}

class _A2001AddNewCustomerFirstState extends State<A2001AddNewCustomerFirst> {
  ...
  Widget build(BuildContext context) {
    print('==============================');
    print('This is A2001 open account first Screen');
    print('==============================');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      Navigator.push(
                                          ...
                                          CupertinoPageRoute(
                                            builder: (context) =>
                                                const A200101PdpaAccountWidget(),
                                          ));
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
