...
class A0703UserGeneralWidgetOld extends StatefulWidget {
  ...
  @override
  _A0703UserGeneralWidgetOldState createState() => _A0703UserGeneralWidgetOldState();
}

class _A0703UserGeneralWidgetOldState extends State<A0703UserGeneralWidgetOld> {
  late A0703UserGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A0703UserGeneralModel());
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: wrapWithModel(
                                  model: _model.formGeneralUserModel,
                                  updateCallback: () => setState(() {}),
