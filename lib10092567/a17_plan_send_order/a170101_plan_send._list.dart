...
import 'package:m_food/a17_plan_send_order/widget/plan_send.dart';
import 'package:m_food/a17_plan_send_order/widget/plan_send_list.dart';
...
class A170101PlanSendList extends StatefulWidget {
  ...
  @override
  _A170101PlanSendListState createState() => _A170101PlanSendListState();
}

class _A170101PlanSendListState extends State<A170101PlanSendList> {
  ...
  Widget build(BuildContext context) {
    print('==============================');
    print('This is A170101 plan send List');
    print('==============================');
                              ...
                              child: Container(
                                  ...
                                  child: SingleChildScrollView(
                                      child: PlanSendList(
                                          ...
                                          orderDataMap: widget.orderDataMap,
                                          uniqueDateFinal:
