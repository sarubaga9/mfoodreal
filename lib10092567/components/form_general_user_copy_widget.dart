...
import 'form_general_user_copy_model.dart';
export 'form_general_user_copy_model.dart';

class FormGeneralUserCopyWidget extends StatefulWidget {
  const FormGeneralUserCopyWidget({Key? key}) : super(key: key);

  @override
  _FormGeneralUserCopyWidgetState createState() =>
      _FormGeneralUserCopyWidgetState();
}

class _FormGeneralUserCopyWidgetState extends State<FormGeneralUserCopyWidget> {
  late FormGeneralUserCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormGeneralUserCopyModel());
