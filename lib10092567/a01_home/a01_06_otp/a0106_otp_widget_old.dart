...
class A0106OtpWidgetOld extends StatefulWidget {
  const A0106OtpWidgetOld({Key? key}) : super(key: key);

  @override
  _A0106OtpWidgetOldState createState() => _A0106OtpWidgetOldState();
}

class _A0106OtpWidgetOldState extends State<A0106OtpWidgetOld> {
  late A0106OtpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A0106OtpModel());
