...
import 'package:m_food/package/date_scroll_view_custom.dart';
import 'package:m_food/package/get_monthly_date_custom.dart';
import 'package:scroll_date_picker/scroll_date_picker.dart';
import 'package:scroll_date_picker/src/widgets/date_scroll_view.dart';



class ScrollDatePickerCustom extends StatefulWidget {
  ScrollDatePickerCustom({
    Key? key,
    this.viewType,
  ...
  /// Indicator displayed in the center of the ScrollDatePickerCustom
  final Widget? indicator;

  @override
  State<ScrollDatePickerCustom> createState() => _ScrollDatePickerCustomState();
}

class _ScrollDatePickerCustomState extends State<ScrollDatePickerCustom> {
  ...
  @override
  void didUpdateWidget(covariant ScrollDatePickerCustom oldWidget) {
  ...
  void _initDateScrollViewCustom() {
    _yearScrollView = DateScrollViewCustom(
        key: const Key("year"),
        dates: _years,
    ...
    _monthScrollView = DateScrollViewCustom(
      key: const Key("month"),
    ...
    _dayScrollView = DateScrollViewCustom(
      key: const Key("day"),
      dates: _days,
  ...
  void _initDays() {
    int _maximumDay =
        getMonthlyDateCustom(year: _selectedDate.year, month: _selectedDate.month);
  ...
  void _onDateTimeChanged() {
    final maximumDay = getMonthlyDateCustom(year: selectedYear, month: selectedMonth);
    _selectedDate =
        DateTime(selectedYear, selectedMonth, min(selectedDay, maximumDay));
    widget.onDateTimeChanged(_selectedDate);
  }

  List<Widget> _getScrollDatePickerCustom() {
    _initDateScrollViewCustom();
    ...
    return Stack(
      ...
      children: [
        Row(
          ...
          children: _getScrollDatePickerCustom(),
        ),
