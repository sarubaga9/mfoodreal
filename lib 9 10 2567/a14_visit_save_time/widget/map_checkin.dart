...
class MapCheckIn extends StatefulWidget {
  final String? latitude;
  final String? longtitude;
  const MapCheckIn({Key? key, this.latitude, this.longtitude})
      : super(key: key);

  @override
  _MapCheckInState createState() => _MapCheckInState();
}

class _MapCheckInState extends State<MapCheckIn> {
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () {
                                    print('Map Banck ...');
                                    print(latitudeToBack);
                                    print(longitudeToBack);
                                    Navigator.pop(context, {
                                      'latitudeToBack': latitudeToBack == 0.0
                                          ? widget.latitude
                                          : latitudeToBack.toString(),
                                      'longitudeToBack': longitudeToBack == 0.0
                                          ? widget.longtitude
                                          : longitudeToBack.toString(),
