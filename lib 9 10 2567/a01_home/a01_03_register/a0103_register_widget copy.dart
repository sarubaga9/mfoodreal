...
import 'a0103_register_model.dart';
export 'a0103_register_model.dart';

class A0103RegisterWidgetOld extends StatefulWidget {
  const A0103RegisterWidgetOld({Key? key}) : super(key: key);

  @override
  _A0103RegisterWidgetOldState createState() => _A0103RegisterWidgetOldState();
}

class _A0103RegisterWidgetOldState extends State<A0103RegisterWidgetOld> {
  late A0103RegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A0103RegisterModel());
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'ตั้งยูสเซอร์เนมของท่าน',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      enabledBorder: OutlineInputBorder(
                                        borderSide: BorderSide(
