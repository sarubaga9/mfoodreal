...
import 'a0102_login_model.dart';
export 'a0102_login_model.dart';

class A0102LoginWidgetOld extends StatefulWidget {
  const A0102LoginWidgetOld({Key? key}) : super(key: key);

  @override
  _A0102LoginWidgetOldState createState() => _A0102LoginWidgetOldState();
}

class _A0102LoginWidgetOldState extends State<A0102LoginWidgetOld> {
  late A0102LoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A0102LoginModel());
