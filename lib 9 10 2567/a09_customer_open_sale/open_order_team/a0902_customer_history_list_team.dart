...
import 'package:m_food/a09_customer_open_sale/open_order_team/a09020_product_history_detail_team.dart';
...
class A0902CustomerHistoryListTeam extends StatefulWidget {
  final String? customerID;
  final String? userIDOpen;
  final String? userNameOpen;
  final String? idEmployee;
  const A0902CustomerHistoryListTeam({
    super.key,
    this.customerID,
  ...
  @override
  _A0902CustomerHistoryListTeamState createState() =>
      _A0902CustomerHistoryListTeamState();
}

class _A0902CustomerHistoryListTeamState
    extends State<A0902CustomerHistoryListTeam> {
  ...
  Widget build(BuildContext context) {
    print('==============================');
    print('This is A0902 Team customer history open list');
    print(widget.customerID);
    print('==============================');
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onTap: () async {
                                                                                Navigator.push(
                                                                                    context,
                                                                                    CupertinoPageRoute(
                                                                                      builder: (context) => A09020ProductHistoryDetailTeam(
                                                                                          idEmployee: widget.idEmployee,
                                                                                          userIDOpen: widget.userIDOpen,
