                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  ...
                                                                  '${orderList['ProductList'][i]['ราคา'].toString()} บาท',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyLarge
                                                                      .override(
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  ...
                                                                  'ราคารวม ${double.parse((double.parse(orderList['ProductList'][i]['ราคา'].toString()) * double.parse(productCount[i].toString())).toString()).toStringAsFixed(2)} บาท',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyLarge
                                                                      .override(
