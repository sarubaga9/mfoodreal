...
import 'form_legal_entity_copy_model.dart';
export 'form_legal_entity_copy_model.dart';

class FormLegalEntityCopyWidget extends StatefulWidget {
  const FormLegalEntityCopyWidget({Key? key}) : super(key: key);

  @override
  _FormLegalEntityCopyWidgetState createState() =>
      _FormLegalEntityCopyWidgetState();
}

class _FormLegalEntityCopyWidgetState extends State<FormLegalEntityCopyWidget> {
  late FormLegalEntityCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormLegalEntityCopyModel());
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                textAlign: TextAlign.start,
                validator:
                    _model.textController21Validator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(8.0, 5.0, 8.0, 5.0),
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  context.pushNamed('A07_05_OpenAccountCopy');
                },
