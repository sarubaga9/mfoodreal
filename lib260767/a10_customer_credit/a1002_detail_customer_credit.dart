...
import 'package:m_food/a10_customer_credit/widget/detail_credit_widget.dart';
...
class A1002DetailCustomerCredit extends StatefulWidget {
  final Map<String, dynamic>? entryMap;

  const A1002DetailCustomerCredit({@required this.entryMap, super.key});

  @override
  _A1002DetailCustomerCreditState createState() =>
      _A1002DetailCustomerCreditState();
}

class _A1002DetailCustomerCreditState extends State<A1002DetailCustomerCredit> {
  ...
  Widget build(BuildContext context) {
    print('==============================');
    print('This is A1002 Customer credit detail ');
    print('==============================');
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 0.0),
                            child:
                                DetailCreditWidget(entryMap: widget.entryMap),
                          ),
                        ],
                      ),
                    ),
