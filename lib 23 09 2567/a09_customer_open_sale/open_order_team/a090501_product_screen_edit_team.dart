...
import 'package:m_food/a09_customer_open_sale/open_order_team/a090503_product_detail_edit_team.dart';
...
class A090501ProductSceenEditTeam extends StatefulWidget {
  ...
  const A090501ProductSceenEditTeam({
    super.key,
    this.orderDataMap,
    this.orderOLD,
    this.customerID,
  ...
  @override
  _A090501ProductSceenEditTeamState createState() =>
      _A090501ProductSceenEditTeamState();
}

class _A090501ProductSceenEditTeamState
    extends State<A090501ProductSceenEditTeam> {
                                                        ...
                                                        if (checkProductSame) {
                                                          ...
                                                          if (productCount[i] ==
                                                            ...
                                                            if (foundmapOrderOld
                                                              ...
                                                              totalBalanaceBefore = double.parse(
                                                                      foundmapOrderOld![
                                                                              'จำนวน']
                                                                          .toString()) *
                                                                  double.parse(
