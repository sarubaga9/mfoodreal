...
import 'package:m_food/a09_customer_open_sale/a090502_product_order_detail_edit%2024%2009%202567.dart';
import 'package:m_food/a09_customer_open_sale/open_order_team/a090502_product_order_detail_edit_team%2024%2009%202567.dart';
...
class A090503ProductDetailEditTeam extends StatefulWidget {
  ...
  const A090503ProductDetailEditTeam({
    super.key,
    this.orderDataMap,
    this.orderOLD,
    this.product,
  ...
  @override
  _A090503ProductDetailEditTeamState createState() =>
      _A090503ProductDetailEditTeamState();
}

class _A090503ProductDetailEditTeamState
    extends State<A090503ProductDetailEditTeam> {
  ...
  loadData() async {
    ...
    QuerySnapshot<Map<String, dynamic>> querySnapshotConvertRatio =
        await FirebaseFirestore.instance
            .collection('PROUDUCT_CONVERT_RATIO')
            .get();

    for (QueryDocumentSnapshot customerDoc in querySnapshotConvertRatio.docs) {
                                        ...
                                        if (orderLast['ProductList'].isEmpty) {
                                          ...
                                          Map<String, dynamic>? result =
                                              await Navigator.push(
                                                  ...
                                                  CupertinoPageRoute(
                                                    builder: (context) =>
                                                        A090502ProductOrderDetailEditTeam(
                                                      customerID:
                                                          widget.customerID,
                                                      imageProduct: imageList,
                                                      orderDataMap: orderLast,
                                                      orderOLD: widget.orderOLD,
                                                      idEmployee:
                                                          widget.idEmployee,
                                                      userIDOpen:
                                                          widget.userIDOpen,
                                                                    ...
                                                                    if (checkProductSame) {
                                                                      ...
                                                                      if (productCount ==
                                                                        ...
                                                                        Map<String,
                                                                          ...
                                                                          (element) =>
                                                                              element!['PRODUCT_ID'] == productDetail!['PRODUCT_ID'] &&
                                                                              element['UNIT'] == unitChooseproductDetail,
                                                                          orElse: () =>
                                                                              {},
                                                                        );
                                                                        ...
                                                                        List<Map<String, dynamic>>?
                                                                            foundmapOrderOldList =
                                                                            dynamicList!.cast<Map<String, dynamic>>();

                                                                        Map<String,
                                                                                dynamic>
                                                                            foundmapOrderOld =
                                                                            foundmapOrderOldList.firstWhere(
                                                                          (element) =>
                                                                              element!['ProductID'] == productDetail!['PRODUCT_ID'] &&
                                                                              element['ยูนิต'] == unitChooseproductDetail,
                                                                          orElse: () =>
                                                                              {},
                                                                        );
                                                                        print(
                                                                            'ORDER OLD');
                                                                        print(foundmapOrderOld[
                                                                            'จำนวน']);
                                                                        ...
                                                                        if (foundmapOrderOld
                                                                          ...
                                                                          totalBalanaceBefore =
                                                                              double.parse(foundmapOrderOld!['จำนวน'].toString()) * double.parse(foundmapRatioBase!['CONVERT_RATIO'].toString());
                                                                        }
                                                                        //-----------------------------
                                                                        ...
                                                                        double
                                                                            totalUnit =
                                                                            double.parse(productCount.toString()) *
                                                                                double.parse(foundmapRatioBase!['CONVERT_RATIO'].toString());

                                                                        NumberFormat
                                                                            numberFormatConvertRatio =
                                                                            NumberFormat("#.000000");
                                                                        String
                                                                            formattedNumberConvertRatio =
                                                                            numberFormatConvertRatio.format(totalUnit);
                                                                        // print(formattedNumber);
                                                                        totalUnit =
                                                                            double.parse(formattedNumberConvertRatio);

                                                                        print(foundmapRatioBase![
                                                                            'CONVERT_RATIO']);
                                                                        print(foundmapRatioBase![
                                                                            'CONVERT_RATIO']);
                                                                        print(foundmapRatioBase![
                                                                        ...
                                                                        if (totalUnit >
                                                                                totalBalanace &&
                                                                            orderLast!['SectionID2'] !=
                                                                                'บุ๊กกิ้งออเดอร์') {
                                                                          Fluttertoast
                                                                              .showToast(
                                                                            msg:
                                                                                'สินค้าไม่พอสำหรับการสั่งค่ะ',
                                                                            backgroundColor:
                                                                                Colors.red.shade900,
                                                                            textColor:
                                                                                Colors.white,
                                                                          ...
                                                                          orderLast['ProductList']
                                                                              .add(
                                                                            {
                                                                              ...
                                                                              'ชื่อสินค้า': productDetail!['NAMES'],
                                                                              'คำอธิบายสินค้า': productDetail!['รายละเอียดสตริง'],
                                                                              'PromotionProductID': productDetail!['PRODUCT_ID'],
                                                                              'สินค้าโปรโมชั่น': false,
                                                                              'คำอธิบายโปรโมชั่น': '',
                                                                              'จำนวน': productCount,
                                                                              'ราคา': priceChooseproductDetail,
                                                                              'ยูนิต': unitChooseproductDetail,
                                                                        ...
                                                                        if (checkProductSame) {
                                                                          ...
                                                                          if (productCountList[i] ==
                                                                            ...
                                                                            Map<String, dynamic>?
                                                                                foundmapRatioBase =
                                                                                productCovertRatio.firstWhere(
                                                                              (element) => element!['PRODUCT_ID'] == productList[i]['PRODUCT_ID'] && element['UNIT'] == unitChoose[i],
                                                                              orElse: () => {},
                                                                            );
                                                                            ...
                                                                            Map<String, dynamic>
                                                                                foundmapOrderOld =
                                                                                foundmapOrderOldList.firstWhere(
                                                                              (element) => element!['ProductID'] == productList[i]['PRODUCT_ID'] && element['ยูนิต'] == unitChoose[i],
                                                                              orElse: () => {},
                                                                            );
                                                                            print('ORDER OLD');
                                                                            ...
                                                                            double
                                                                                totalUnit =
                                                                                double.parse(productCountList[i].toString()) * double.parse(foundmapRatioBase!['CONVERT_RATIO'].toString());
                                                                            ...
                                                                            Map<String, dynamic>?
                                                                                foundMap =
                                                                                resultList.firstWhere(
                                                                              (element) => element['PRODUCT_ID'] == productList[i]['PRODUCT_ID'],
                                                                              orElse: () => {},
                                                                            );
                                                                            //=============== โหลด balance อีกครั้ง =========================
                                                                            ...
                                                                            QuerySnapshot
                                                                                querySnapshot =
                                                                                await FirebaseFirestore.instance.collection(AppSettings.customerType == CustomerType.Test ? 'ProductTest' : 'Product').where('PRODUCT_ID', isEqualTo: foundMap['PRODUCT_ID']).get();
                                                                            ...
                                                                            totalBalanace =
                                                                                totalBalanace + totalBalanaceBefore;

                                                                            if (totalUnit > totalBalanace &&
                                                                                orderLast!['SectionID2'] != 'บุ๊กกิ้งออเดอร์') {
                                                                              Fluttertoast.showToast(
                                                                              ...
                                                                              for (var element in orderLast!['ProductList']) {
                                                                                print(element['จำนวน']);
                                                                                print(element['ราคา']);
                                                                              ...
                                                                              orderLast['ยอดรวม'] = total;
                                                                              print(orderLast!['ยอดรวม']);

                                                                              Fluttertoast.showToast(msg: "ใส่สินค้าลงตระกร้าแล้วค่ะ", toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.CENTER, timeInSecForIosWeb: 5, backgroundColor: Colors.green.shade900, textColor: Colors.white, fontSize: 16.0);

                                                                              productCountList[i] = 0;
                                                                            }
                                                                            // orderLast['ProductList'].add(
                                                                            //   {
                                                                            //     'DocID': productList[i]['DocId'],
