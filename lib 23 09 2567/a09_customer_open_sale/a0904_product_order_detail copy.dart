...
class A0904ProductOrderDetailCopy extends StatefulWidget {
  final String? customerID;
  final List<String>? imageProduct;

  final Map<String, dynamic>? orderDataMap;
  const A0904ProductOrderDetailCopy(
      {super.key, this.orderDataMap, this.imageProduct, this.customerID});

  @override
  _A0904ProductOrderDetailCopyState createState() =>
      _A0904ProductOrderDetailCopyState();
}

class _A0904ProductOrderDetailCopyState extends State<A0904ProductOrderDetailCopy> {
