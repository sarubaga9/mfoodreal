...
class A090503ProductDetailEdit extends StatefulWidget {
  ...
  const A090503ProductDetailEdit(
      {super.key,
      this.orderDataMap,
      this.orderOLD,
      this.product,
  ...
  @override
  _A090503ProductDetailEditState createState() =>
      _A090503ProductDetailEditState();
}

class _A090503ProductDetailEditState extends State<A090503ProductDetailEdit> {
